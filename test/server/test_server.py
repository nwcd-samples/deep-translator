...
class TestServer(unittest.TestCase):
    ...
    Methods:
        ...
        mock_client: Simulates a templates sending audio data to the server for
                     processing.
    ...
    async def mock_client(self, audio_file):
        """
        Simulate a templates sending audio data to the server.
    ...
    def test_server_response(self):
        ...
        for audio_file_name, data in annotations.items():
            ...
            # Run the mock templates for each audio file
